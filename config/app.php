...
return [
    ...
    'providers' => [
         ...
         */
        TravelPlanner\Providers\AppServiceProvider::class,
        TravelPlanner\Providers\AuthServiceProvider::class,
        // TravelPlanner\Providers\BroadcastServiceProvider::class,
